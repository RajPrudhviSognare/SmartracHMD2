...
public class InOutTime_ApprovalActivity extends AppCompatActivity {

    private String TAG_ATTENDANCE_TYPE = "in"; //"In & out Time"

    private Spinner attendanceapproval_InOutTimeSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_out_time_approval);
    ...
    private void initAllViews(){
        ...
        imageLoader = new ImageLoader(InOutTime_ApprovalActivity.this);
        ...
        public void handleMessage(Message msg){
            ...
            if(client.responseCode==200){
                ...
                if(STATUS.equalsIgnoreCase("true")){
                    ...
                    InOutTimeattendanceApprovalDetailsListViewID.setAdapter(null); //Added Later
                    showSuccessDialog();
    ...
    private void showSuccessDialog(){
        ...
        final android.app.AlertDialog.Builder aldb = new android.app.AlertDialog.Builder(InOutTime_ApprovalActivity.this);
    ...
    private void showFailureDialog(){
        //Alert Dialog Builder
        final AlertDialog.Builder aldb = new AlertDialog.Builder(InOutTime_ApprovalActivity.this);
