...
public class UpdateGroupActivity extends AppCompatActivity {
    ...
    private String TAG_ASSOCIATEID = "associate_id";
    ...
    private List<String> selectedassociate_idList=null;
    ...
    private String ass_id="",ass_name="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.topbar_editgroup);
        ass_id=getIntent().getStringExtra("associate_id");
        ass_name=getIntent().getStringExtra("associate_name");
        initAllViews();
        if(CommonUtils.isInternelAvailable(UpdateGroupActivity.this)){
    ...
    private void initAllViews() {
        ...
        groupname.setText(ass_name);
        associate_idList = new ArrayList<String>(0);
        selectedassociate_idList=new ArrayList<String>(0);
        ...
        messagesTL_checkBox_listheaderID.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    ...
                    messagesTLAssociatesListViewID.setAdapter(new CustomAdapterForAssociatesList(UpdateGroupActivity.this));
        ...
        messagesTLtopbarusericonImageViewID.setOnClickListener(new ImageView.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UpdateGroupActivity.this, ChangePasswordActivity.class);
                startActivity(i);
    ...
    private void sendMessageToServer(){
        ...
        progressDialog.show();
        client = new RestFullClient(Constants.BASE_URL+Constants.SENDMESSAGE_EDIT_GROUP_URI);
        client.AddParam("group_id",ass_id);
    ...
    private void showSuccessDialog(){
        ...
        android.app.AlertDialog.Builder aldb = new android.app.AlertDialog.Builder(UpdateGroupActivity.this);
        ...
        aldb.setNeutralButton("Ok", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent i=new Intent(UpdateGroupActivity.this,AddGroupActivity.class);
    ...
    private void requestAssociateList(){
        ...
        selectedassociate_idList.clear();
        ...
        progressDialog.setCancelable(false);
        progressDialog.show();
        client = new RestFullClient(Constants.BASE_URL+Constants.SENDMESSAGE_GROUP_DETAILS_URI);
            ...
            if(client.responseCode==200){
                ...
                if(STATUS.equalsIgnoreCase("true")) {
                    ...
                    if (JOBJECT_DATA != null) {
                        ...
                        JSONArray selectedpendingDateArray = JOBJECT_DATA.getJSONArray("associate_lists");
                        JSONArray pendingDateArray = JOBJECT_DATA.getJSONArray("associate");
                        JSONObject c = null;
                        String id = null;
                        String isd = null;
                        String fname = null;
                        ...
                        if(selectedpendingDateArray.length()==0){
                        }
                        if(selectedpendingDateArray.length()!=0){

                            for(int i = 0; i < selectedpendingDateArray.length(); i++) {

                                try {
                                    c = selectedpendingDateArray.getJSONObject(i);
                                    ...
                                    if (c != null) {
                                        ...
                                        selectedassociate_idList.add(id);
    ...
    public class CustomAdapterForAssociatesList extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view;
            UpdateGroupActivity.CustomAdapterForAssociatesList.ViewHolder viewHolder = new CustomAdapterForAssociatesList.ViewHolder();
            ...
            final UpdateGroupActivity.CustomAdapterForAssociatesList.ViewHolder holder = (UpdateGroupActivity.CustomAdapterForAssociatesList.ViewHolder)view.getTag();
            ...
            else if(selectedassociate_idList.contains(associate_idList.get(position))){
                holder.checkbox.setChecked(true);
                //selectionSet.add(associate_idList.get(position));
            }
            else{
    ...
    private void showFailureDialog(){
        //Alert Dialog Builder
        AlertDialog.Builder aldb = new AlertDialog.Builder(UpdateGroupActivity.this);
