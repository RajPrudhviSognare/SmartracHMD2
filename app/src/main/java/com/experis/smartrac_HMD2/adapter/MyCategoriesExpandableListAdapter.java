package com.experis.smartrac_HMD2.adapter;
...
public class MyCategoriesExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            viewHolderParent.tvMainCategoryName = (TextView) convertView.findViewById(R.id.tvMainCategoryName);
            viewHolderParent.cbMainCategory = (CheckBox)convertView.findViewById(R.id.cbMainCategory);
            viewHolderParent.ivCategory = (ImageView) convertView.findViewById(R.id.ivCategory);
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            viewHolderChild.tvSubCategoryName = (TextView) convertView.findViewById(R.id.tvSubCategoryName);
            viewHolderChild.cbSubCategory = (CheckBox)convertView.findViewById(R.id.cbSubCategory);
