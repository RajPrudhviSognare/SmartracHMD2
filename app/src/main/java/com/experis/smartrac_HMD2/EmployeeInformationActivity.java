...
public class EmployeeInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hrms_employee_info_fragment);
    ...
    private void initAllViews(){
        ...
        employeeinfoPageEmployeeCodeTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeCodeTextViewID);
        employeeinfoPageEmployeeNameTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeNameTextViewID);
        employeeinfoPageFatherNameTextViewID = (TextView)findViewById(R.id.employeeinfoPageFatherNameTextViewID);
        employeeinfoPageEmployeeDOBTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeDOBTextViewID);
        employeeinfoPageEmployeeDOJTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeDOJTextViewID);
        employeeinfoPagePFNumberTextViewID = (TextView)findViewById(R.id.employeeinfoPagePFNumberTextViewID);
        employeeinfoPageEmployeePFUANTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeePFUANTextViewID);
        employeeinfoPageEmployeeESICNumberTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeESICNumberTextViewID);
        employeeinfoPageEmployeePANTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeePANTextViewID);
        employeeinfoPageEmployeeClientNameTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeClientNameTextViewID);
        employeeinfoPageEmployeeEMailAddressTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeEMailAddressTextViewID);
        employeeinfoPageEmployeePermAddressTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeePermAddressTextViewID);
        employeeinfoPageEmployeeMobile1TextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeMobile1TextViewID);
        employeeinfoPageEmployeeMobile2TextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeMobile2TextViewID);
        employeeinfoPageEmployeeStatusTextViewID = (TextView)findViewById(R.id.employeeinfoPageEmployeeStatusTextViewID);

        //Progress Dialog
        progressDialog = new ProgressDialog(EmployeeInformationActivity.this);
    }

    private void getEmployeeDetails(){
        progressDialog.setMessage("Requesting Employee Details... Please wait!");
    ...
    private void setEmployeeDetails(){
        ...
        employeeinfoPageEmployeeEMailAddressTextViewID.setText(MailAddress);
